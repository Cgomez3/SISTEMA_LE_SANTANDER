...
import static Capa_ProgPago.ImportarComprobantes.proveedoressincuenta;
import java.io.File;
 ...
 * @author cristhian
 */
public class frmExportarGPFinal extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form frmExportarGPFinal
     */
    public frmExportarGPFinal() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtruta, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 200, 220, -1));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 200, 30, 20));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 240, 130, 30));
        ...
        jPanel1.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 140, -1, 20));
        ...
        jPanel1.add(txtcorrelativo, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 140, 110, -1));

        txtchequera.setFont(new java.awt.Font("Calibri", 0, 11)); // NOI18N
        jPanel1.add(txtchequera, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 110, 260, -1));

        jLabel8.setFont(new java.awt.Font("Calibri", 0, 11)); // NOI18N
        jLabel8.setText("NRO. OPE");
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 170, -1, 20));

        txtlote.setFont(new java.awt.Font("Calibri", 0, 11)); // NOI18N
        jPanel1.add(txtlote, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 140, 90, -1));
        ...
        buttonGroup1.add(rbtdetraccion);
        ...
        jLabel10.setText("Fec. Documento");
        jPanel1.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 170, -1, 20));
        ...
        jPanel1.add(dcdetracc, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 170, 110, -1));
        ...
        jPanel1.add(txtnroope, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 170, 90, -1));
        ...
        jPanel1.add(btnsalir, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 240, 130, 30));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String ruta = "";
        try {
            jF1.setFileSelectionMode(jF1.DIRECTORIES_ONLY);
...
//                            }
                            ...
                            for (int i = 0; i < lstcomprobante.size(); i++) {
                                ...
                                if (rbtdetraccion.isSelected()) {
                                    ...
                                    escribir.write("PAG." + lstcomprobante.get(i).getGlosaComprante().trim());
                                }
...
//                                }
                            ...
                            LProgPagosCabecera lpp = new LProgPagosCabecera();
                            ArrayList<EComprobante> lstdetalle = lpp.lstdetalleprg(lstcab.get(cboprogramacion.getSelectedIndex() - 1).getCod_programacion());
                            double totalPagoBancosol = 0;
                            double totalPagoBancodol = 0;
                            double totalConPagoBancosol = 0;
                            double totalConPagoBancodol = 0;
            DecimalFormat formato1 = new DecimalFormat("###,##0.00", simbolo);
            DecimalFormat formato2 = new DecimalFormat("##0.00", simbolo);
                            if (rbtpagos.isSelected()) {
                                for (int i = 0; i < lstdetalle.size(); i++) {
                                    totalPagoBancosol += lstdetalle.get(i).getMontoPagarRefSoles();
                                    totalPagoBancodol += lstdetalle.get(i).getMontoPagarRefDol();
                                }

                                for (int i = 0; i < lstcomprobante.size(); i++) {
                                    totalConPagoBancosol += lstcomprobante.get(i).getMontoPagar();
                                    totalConPagoBancodol += lstcomprobante.get(i).getMontoPagarDOL();
                                }
                                if (moneda.equalsIgnoreCase("SOLES")) {
                                    proveedoressincuenta="";
                                    proveedoressincuenta += "<html><body>";
                                    proveedoressincuenta +="<p>Se exportó correctamente el archivo " + nombrearchivo + "</p>";
                                    proveedoressincuenta +="<p>Monto Pagado: " + formato1.format(totalPagoBancosol) + "</p>";
                                    proveedoressincuenta +="<p>Monto Contabilizado: " +formato1.format(totalConPagoBancosol) + "</p>";
                                    proveedoressincuenta +="<p>Diferencia: " +  formato1.format((totalPagoBancosol - totalConPagoBancosol))  + " "+ moneda + ".</p></body></html>";
                                    JOptionPane.showMessageDialog(this, proveedoressincuenta);
                                    //JOptionPane.showMessageDialog(this, "Se exportó correctamente el archivo " + nombrearchivo + " Monto total " + totalPagoBancosol + " Monto Consolidado " + totalConPagoBancosol + " diferencia " + (totalPagoBancosol - totalConPagoBancosol) + " " + moneda + ".");
                                } else {
                                    proveedoressincuenta="";
                                    proveedoressincuenta += "<html><body>";
                                    proveedoressincuenta +="<p>Se exportó correctamente el archivo " + nombrearchivo + "</p>";
                                    proveedoressincuenta +="<p>Monto Pagado: " + formato1.format(totalPagoBancodol) + "</p>";
                                     proveedoressincuenta +="<p>Monto Contabilizado: " +formato1.format( totalConPagoBancodol )+ "</p>";
                                    proveedoressincuenta +="<p>Diferencia: " +  formato1.format((totalPagoBancodol  - totalConPagoBancodol))  + " "+ moneda + ".</p></body></html>";
                                    JOptionPane.showMessageDialog(this, proveedoressincuenta);
                                }
                            } else {
                                LDetraccion detra = new LDetraccion();
                                ArrayList<EDetraccTxt> lstbusq = detra.ListarDetracciones(lstcab.get(cboprogramacion.getSelectedIndex() - 1).getCod_programacion());
                                for (int i = 0; i < lstbusq.size(); i++) {
                                    totalPagoBancosol += lstbusq.get(i).getImporte();
                                    totalPagoBancodol += lstbusq.get(i).getTotalDol();
                                }
                                for (int i = 0; i < lstcomprobante.size(); i++) {
                                    totalConPagoBancosol += lstcomprobante.get(i).getMontoRetDet();
                                    totalConPagoBancodol += lstcomprobante.get(i).getMontoRetDet();
                                }
                                if (moneda.equalsIgnoreCase("SOLES")) {
                                    proveedoressincuenta="";
                                    proveedoressincuenta += "<html><body>";
    ...
    public String fechaformateador(Date fecha) {
    ...
    private boolean Validar() {
        ...
        } else if (dcdetracc.getDate() == null) {
            JOptionPane.showMessageDialog(this, "Ingrese la fecha del Documento.");
            dcdetracc.requestFocus();
        } else {
